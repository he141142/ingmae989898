...
function animationPipeline() {
  var self = this;
  var questions = ['Elephant', 'Lion', 'Car', 'Airport', 'Cat', 'Zoo', 'Lamp', 'Window', 'Laptop', 'Table'],
      answers = [['Lion', 'Elephant', 'Cat', 'Dog'], ['Bear', 'Lion', 'Bird', 'Rabbit'], ['Air plane', 'Train', 'Bus', 'Car'], ['Building', 'Stadium', 'Museum', 'Airport'], ['Dog', 'Hedgehog', 'lizard', 'Cat'], ['Museum', 'Zoo', 'City', 'Park'], ['Desk', 'Table', 'Lamp', 'Chair'], ['Door', 'Gate', 'Window', 'Tunnel'], ['Laptop', 'Macbook', 'Computer', 'Chair'], ['Bitmap', 'Table', 'Raster', 'GIF']],
  ...
  self.anwerClicked = function (e) {
    ...
    console.log(yourAns); // Get the actual answer index 

    var actualCorrectAnswerIndex = gameAnswers[gameIndex];
    var corr = document.querySelectorAll("[data-index=\"".concat(actualCorrectAnswerIndex, "\""))[0]; // Correct answer
  ...
  self.updateClock = function () {
    ...
    time.innerText = "".concat(timmerIndex);
  };
  ...
  self.setupUserInterfaceWithData = function () {
    ...
    question.src = "./resource/question/" + ques + ".png";
    questionNUmb.innerText = "" + correctQUan + "/" + questions.length; // Add answers to buttons
...
function gameEngine() {
  var interval = setInterval(function () {
    if (document.readyState === 'complete') {
      ...
      var pipe = animationPipeline(); //   window.onresize = function(event) {
...
}), h('div.score', [h('p', "800")])]), h('div.middle', [h('p', "10/15"), h('p', "15")]), h('div.right', [h('img', {
  props: {
    src: "../—Pngtree—vector users icon_4144740.png"
  }
}), h('div.score', [h('p', "800")])])]);
var VNode = h('div#question', [h('div.big-image', [h('img', {
  props: {
    src: "../resource/unnamed.png"
  }
})])]);
var NodeAnswer = h('div.answer', [h('div.one', {
  dataset: {
    index: 0
  }
}, "Elephant"), h('div.two', {
